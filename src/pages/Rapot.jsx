      ...
      <div className="flex flex-col gap-5">
        ...
        <div>
          <h1 className="text-xl font-semibold md:text-2xl">
            Rapot Tahun Ajaran Sebelumnya
          </h1>
        </div>

        <div className="">
          <div className="flex flex-col gap-3 w-full sm:flex-row  justify-end ">
            <div className="sm: 2xl:w-1/6 ">
              <SearchFilter />
            </div>
          </div>
        </div>
        ...
        <PopUpEdit
          title="Ubah rapot tahun ajaran sebelumnya"
          icon={<PiBookBookmarkFill />}
          isOpenPopUpEdit={isOpenPopUpEdit}
          setIsOpenPopUpEdit={setIsOpenPopUpEdit}
        >
        ...
        <PopUpDelete
          title="Hapus rapot tahun ajaran sebelumnya"
          icon={<PiBookBookmarkFill />}
          isOpenPopUpDelete={isOpenPopUpDelete}
          setIsOpenPopUpDelete={setIsOpenPopUpDelete}
        >
