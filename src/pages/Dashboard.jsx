    ...
    <Layout>
      <div className="flex flex-col">
        ...
        <div className="grid xl:grid-cols-4 xl:gap-4 lg:grid-cols-2 gap-2 sm:grid-cols-1 mt-5">
          <div className="bg-[#BDF1FF] rounded-lg w-11/12 sm:mt-3">
          ...
          <div className="bg-[#FFDDBD] rounded-lg w-11/12 sm:mt-3">
            <div className="flex flex-row justify-center gap-8 px-6 py-1">
              <div>
          ...
          <div className="bg-[#E4F1CB] rounded-lg w-11/12 sm:mt-3">
            <div className="flex flex-row justify-center gap-8 px-6 py-1">
              <div>
          ...
          <div className="bg-[#DBBDFF] rounded-lg w-11/12 sm:mt-3">
            <div className="flex flex-row justify-center gap-8 px-6 py-1">
              <div>
