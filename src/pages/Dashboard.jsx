    ...
    <Layout>
      <div className="flex flex-col">
        ...
        <div class="grid xl:grid-cols-4 xl:gap-4 lg:grid-cols-2 lg:gap-2 sm:grid-cols-1 mt-5">
          <div className="bg-[#ef3a3a] rounded-lg w-11/12 sm:mt-3">
          ...
          <div className="bg-[#f4b23f] rounded-lg w-11/12 sm:mt-3">
            <div className="flex flex-row justify-center gap-8 px-6 py-1">
              <div>
          ...
          <div className="bg-[#44d6f0] rounded-lg w-11/12 sm:mt-3">
            <div className="flex flex-row justify-center gap-8 px-6 py-1">
              <div>
          ...
          <div className="bg-[#f4f746] rounded-lg w-11/12 sm:mt-3">
            <div className="flex flex-row justify-center gap-8 px-6 py-1">
              <div>
